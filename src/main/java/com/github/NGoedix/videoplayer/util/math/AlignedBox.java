...
public class AlignedBox {
    ...
    public Box getBB(BlockPos pos) {
        return new Box((double)(this.minX + (float)pos.getX()), (double)(this.minY + (float)pos.getY()), (double)(this.minZ + (float)pos.getZ()), (double)(this.maxX + (float)pos.getX()), (double)(this.maxY + (float)pos.getY()), (double)(this.maxZ + (float)pos.getZ()));
    }

    public VoxelShape voxelShape() {
        return VoxelShapes.cuboid((double)this.minX, (double)this.minY, (double)this.minZ, (double)this.maxX, (double)this.maxY, (double)this.maxZ);
    }

    public VoxelShape voxelShape(BlockPos pos) {
        return VoxelShapes.cuboid((double)(this.minX + (float)pos.getX()), (double)(this.minY + (float)pos.getY()), (double)(this.minZ + (float)pos.getZ()), (double)(this.maxX + (float)pos.getX()), (double)(this.maxY + (float)pos.getY()), (double)(this.maxZ + (float)pos.getZ()));
    }
